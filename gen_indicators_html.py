...
<div style="margin: 0 0px; background-color: white;">
    ...
    <div style="margin-top: 20px; text-align:center">
        <table style="margin:auto">
            <tr>
                <td>
                    <img src="{ccy1}-icon.png"
                         style="width:20px; height:20px; margin-top:3px"/>
                    <img src="{ccy2}-icon.png"
                         style="width:20px; height:20px; margin-top:3px"/>
                </td>
                <td>
                    <span style="font-family:Helvetica; font-weight:bold; font-size:16px; text-align:center">
                        &nbsp;{ccy1_cn}兑{ccy2_cn}&nbsp;{pair}
                    </span>
                </td>
            </tr>
        </table>
    ...
    <div style="margin-top: 8px;">
        <div style="margin-left: 0px;">
            <img src="{arrow_pic}"
                 style="width:20px; height:20px; margin-bottom: 12px"/>
            <span class="inlineblock">
                <span class="top bold inlineblock"
                      style="float: left; margin-top: 5px;">
                    <span class="arial_11">{last_px}</span>
                    <span class="arial_11 {chgcolor}"
                          style="margin-left:1px;">{chg}</span>
                    <span class="arial_11 {chgcolor} pid-166-pcp parentheses">{chgpct}</span>
                    <span class="bottom lighterGrayFont arial_11"
                          style="margin-left: -154px;margin-top: 31px; float: left;"></span>
                    <span id="timeShow" class="bold"
                          style="margin-left: 3px; font-size: 9px; color: gray">这里显示时间</span>
                </span>
            </span>
        </div>
    </div>
...
<div class="halfSizeColumn" style="margin-top: -30px;">
    <h3>
        <table width="100%">
            <tr>
                <td>&nbsp;移动平均</td>
                <td align="right">
                    <font size=1>K线周期&nbsp;</font>
                    <font size=2 color="blue">{freq_cn}&nbsp;&nbsp;</font>
                </td>
            </tr>
        </table>
    </h3>
    ...
    <table class="genTbl closedTbl movingAvgsTbl" id="curr_table">
        ...
        <tr>
            ...
            <td>{ma5_str}&nbsp; <span
                    class="greenFont bold">{ma5_comment}</span>
            </td>
            <td>{ema5_str}&nbsp; <span
                    class="greenFont bold">{ema5_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">MA10</td>
            <td>{ma10_str}&nbsp; <span
                    class="greenFont bold">{ma10_comment}</span>
            </td>
            <td>{ema10_str}&nbsp; <span
                    class="greenFont bold">{ema10_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">MA20</td>
            <td>{ma20_str}&nbsp; <span
                    class="greenFont bold">{ma20_comment}</span>
            </td>
            <td>{ema20_str}&nbsp; <span
                    class="greenFont bold">{ema20_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">MA50</td>
            <td>{ma50_str}&nbsp; <span
                    class="greenFont bold">{ma50_comment}</span>
            </td>
            <td>{ema50_str}&nbsp; <span
                    class="greenFont bold">{ema50_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">MA100</td>
            <td>{ma100_str}&nbsp; <span
                    class="greenFont bold">{ma100_comment}</span>
            </td>
            <td>{ema100_str}&nbsp; <span
                    class="greenFont bold">{ema100_comment}</span>
            </td>
        </tr>
        <tr>
...
<div class="halfSizeColumn tech_indicator_div" style="margin-top: -20px;">
    ...
    <table class="genTbl closedTbl movingAvgsTbl float_lang_base_2"
        ...
        <tr>
            ...
            <td class="left textNum bold"><span class="greenFont bold">{rsi_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">ADX(14)</td>
            <td class="right">{adx_str}</td>
            <td class="left textNum bold"><span class="greenFont bold">{adx_comment}</span>
            </td>
        </tr>
        <tr>
            <td class="first left symbol">STOCH(9,6)</td>
            <td class="right">{stoch:.2f}</td>
            <td class="left textNum bold"><span class="greenFont bold">{stoch_comment}</span>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="left textNum bold"><span class="greenFont bold">{roc_comment}</span>
            </td>
        </tr>
        <tr>
